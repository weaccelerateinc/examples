...
export const laptop: Product = {
  ...
  features: [
    ...
    "Crafted from smooth, lightweight neoprene for a sleek look",
    "Customizable front with a solid black back for a personal touch",
    "Water-resistant and durable material to withstand daily use"
  ]
};
