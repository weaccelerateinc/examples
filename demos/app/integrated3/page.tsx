...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement> | boolean, useDefaultCard?: boolean) => {
              ...
              <div className="flex flex-col gap-3">
                ...
                {defaultCard && (
                  <button
                    ...
                    className="w-full border border-slate-200 bg-transparent hover:bg-slate-50 text-slate-600 font-semibold py-4 rounded-xl transition"
                  >
